...
1. Go to [Releases](../../releases) and download the zip for your OS (`Yuri-linux.zip` or `Yuri-windows.zip`)
2. Extract the zip anywhere
3. Run `launch.sh` (Linux/Mac) or `launch.bat` (Windows)
...
<p align="center">
  <a href="https://discord.gg/8VhKD2QQHc">
