...
public class NumberProperty extends Property<Double> {
    ...
    public NumberProperty(String label, double value, double min, double max, double increment, Supplier<Boolean> dependency, Representation representation) {
    ...
    public NumberProperty(String label, double value, double min, double max, double increment, Supplier<Boolean> dependency) {
