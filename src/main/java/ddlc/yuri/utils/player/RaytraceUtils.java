...
public class RaytraceUtils implements IMinecraft {
    public static MovingObjectPosition raytrace(final Vector2f rotation, final double range) {
        return raytrace(rotation, range, 0);
    }

    public static MovingObjectPosition raytrace(final Vector2f rotation, final double range, final float expand) {
        return raytrace(rotation, range, expand, mc.thePlayer);
    }

    public static MovingObjectPosition raytrace(final Vector2f rotation, final double range, final float expand, Entity entity) {
