package ddlc.yuri.utils.render.shader3d;
...
public abstract class Shader {
    ...
    public Shader(final String fragmentShader) {
        ...
        try {
            final InputStream vertexStream = getClass().getResourceAsStream("/assets/minecraft/yuri/shaders/vertex.vert");
            ...
            final InputStream fragmentStream = getClass().getResourceAsStream("/assets/minecraft/yuri/shaders/impl/" + fragmentShader);
