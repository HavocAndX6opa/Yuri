...
@AllArgsConstructor
public class CustomVelocity implements VelocityMode {
    ...
    public void onPacket(PacketReceivedEvent event) {
        ...
        if (event.getPacket() instanceof S12PacketEntityVelocity) {
            ...
            if (p.getEntityID() == mc.thePlayer.getEntityId()) {
                ...
                int y = p.getMotionY();
                int z = p.getMotionZ();
                p.setMotion((int) (x * parent.xModify.getValue()), (int) (y * parent.yModify.getValue()), (int) (z * parent.zModify.getValue()));
            }
        }
    }
}
