...
@ModuleInfo(label = "Damage Effects", description = "Adds visual effects when you target takes damage", category = ModuleCategory.RENDER)
public final class DamageEffectsModule extends Module {
